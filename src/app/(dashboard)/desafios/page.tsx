...
export default async function DesafiosPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Saldo - PRIMEIRO (mais importante) */}
      <Card className="relative overflow-hidden bg-gradient-to-br from-pink-500 via-rose-500 to-red-500 text-white shadow-xl max-w-2xl mx-auto">
      ...
      {/* Banner de Engajamento - Abaixo do saldo */}
