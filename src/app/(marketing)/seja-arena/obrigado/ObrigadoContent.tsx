...
const MAX_POLL_TIME = 8000; // 8 segundos
      ...
      <main className="min-h-screen flex flex-col items-center justify-center px-4 py-8">
        ...
        <div className="text-center max-w-md">
          ...
          <p className="text-lg text-gray-600 mb-2">
            Você foi aprovado para a comunidade {siteName}!
          </p>
          <p className="text-gray-500 mb-8">
            Crie sua conta agora para ter acesso a conteúdos exclusivos,
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-primary-600 to-accent-500 text-white font-semibold rounded-full hover:from-primary-700 hover:to-accent-600 transition-all duration-200 transform hover:scale-105 shadow-lg"
          >
