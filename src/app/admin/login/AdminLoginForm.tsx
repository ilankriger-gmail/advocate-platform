...
/**
 * Formulario de login do painel administrativo
 *
 * Client Component que renderiza o formulario de autenticacao admin.
...
export default function AdminLoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      ...
      // Se success, o Server Action ja redireciona para /admin
    });
  };
