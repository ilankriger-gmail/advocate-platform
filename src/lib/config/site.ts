...
const DEFAULT_VALUES: Record<SiteSettingKey, string> = {
  ...
  email_onboarding1_benefits: 'Participar de desafios e ganhar corações,Completar exercícios físicos diários,Trocar corações por prêmios incríveis,Conectar com a comunidade',
  ...
  email_onboarding2_message: 'Você já viu os desafios disponíveis? Complete exercícios simples e acumule corações para trocar por prêmios!',
  ...
  email_onboarding2_footer: 'Quanto mais você participa, mais corações acumula!',
  // Onboarding Email 3 (reengajamento)
  email_onboarding3_subject: '{{name}}, suas corações estão esperando!',
  email_onboarding3_greeting: 'Oi {{name}}!',
  email_onboarding3_message: 'Você sabia que pode trocar suas corações por prêmios incríveis? Não deixe suas corações paradas, venha participar dos desafios!',
